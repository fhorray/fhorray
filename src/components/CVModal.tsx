export const CVModal = (props: {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-neutral-900 w-full max-w-xs rounded-2xl border border-gray-200 dark:border-neutral-800 overflow-hidden transform scale-95 transition-all duration-300">
        <div className="p-6">
          ...
          <div className="grid gap-3">
            <a
              ...
              className="flex items-center justify-between p-4 bg-gray-50 dark:bg-neutral-800 hover:bg-purple-50 dark:hover:bg-purple-900/30 border border-gray-100 dark:border-neutral-700 rounded-xl transition-all group"
            >
